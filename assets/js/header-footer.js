document.addEventListener('DOMContentLoaded', () => {
    ...
    footer.innerHTML = `
        <footer>
            ...
            <div class="copyright">
                <p>© 2025 Sample Website. All rights reserved. Managed by <a href="https://allworldseodigitalmarketingsolutions.com/" target="_blank"><strong>AllWorld SEO</strong></a>.</p>
            </div>
        </footer>
    `;
